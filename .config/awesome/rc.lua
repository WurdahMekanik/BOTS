...
menubar.utils.terminal = terminal -- Set the terminal for applications requiring it
-- }}}
...
for s = 1, screen.count() do
    ...
    -- Create imagebox widget which contains an icon indicating which layout in use.
    ...
    -- Bring it all together (with the tasklist in the middle)
