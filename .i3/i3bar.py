...
class Base:
	...
	def __init__(self):
		...
		# inactive - very dim, mimicing grey-out. (meant to be brighter than bar's bg color)
		...
		# Listing connections by color on i3bar, helps identify which ssh session is which
		#
                '''
		self.conns = {}
		f = open (".ssh/config")
